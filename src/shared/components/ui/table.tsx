...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
    ({ className, ...props }, ref) => (
        <div className="relative w-full overflow-auto -my-1">
            <table
                ref={ref}
                className={cn(
...
>(({ className, ...props }, ref) => (
    <thead ref={ref} className={cn('[&_tr]:brightness-130', className)} {...props} />
))
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
    ({ className, ...props }, ref) => (
        <tr
            ref={ref}
            className={cn(
                'bg-surface transition-all duration-200  data-[state=selected]:bg-brand',
                className
            )}
            {...props}
        />
...
>(({ className, ...props }, ref) => (
    <td
        ref={ref}
        className={cn('p-4 align-middle text-secondary [&:has([role=checkbox])]:pr-0', className)}
        {...props}
    />
))
